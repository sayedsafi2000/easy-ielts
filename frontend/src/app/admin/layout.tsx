...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <ProtectedRoute roles={["admin", "examiner"]} redirectTo="/admin/login">
      <div className="grid min-h-screen overflow-hidden" style={{ gridTemplateColumns: "260px minmax(0,1fr)", background: "#fff" }}>
        <aside className="flex flex-col py-4 px-4 border-r border-[#ececf3] h-screen sticky top-0 overflow-y-auto" style={{ background: "#fafafe" }}>
