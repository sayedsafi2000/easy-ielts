      ...
      <footer className="bg-slate-50 border-t border-slate-200 py-12">
        <div className="max-w-7xl mx-auto px-5 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-10">
            ...
            {[
              { heading: "Platform", links: ["Dashboard", "Listening", "Reading", "Writing", "Speaking"] },
              { heading: "Company", links: ["About", "Blog", "Careers", "Press"] },
              { heading: "Support", links: ["Help Centre", "Contact", "Privacy", "Terms"] },
            ].map((col) => (
              <div key={col.heading}>
                <p className="text-xs font-bold text-slate-900 uppercase tracking-wide mb-3">{col.heading}</p>
                <ul className="space-y-2">
                  {col.links.map((l) => (
                    <li key={l}><a href="#" className="text-xs text-slate-500 hover:text-slate-900 cursor-pointer transition-colors">{l}</a></li>
                  ))}
                </ul>
              </div>
            ))}
          ...
          <div className="border-t border-slate-200 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3">
            ...
            <div className="flex gap-4 text-xs text-slate-400">
              <a href="#" className="hover:text-slate-700 cursor-pointer">Privacy</a>
              <a href="#" className="hover:text-slate-700 cursor-pointer">Terms</a>
              <a href="#" className="hover:text-slate-700 cursor-pointer">Cookies</a>
            </div>
          </div>
        </div>
      </footer>
